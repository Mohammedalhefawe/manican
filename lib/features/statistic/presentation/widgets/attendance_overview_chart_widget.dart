...
import 'package:manican/core/components/custom_drop_down.dart';
...
class _AttendanceOverviewChartState extends State<AttendanceOverviewChart>
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Row(
                        ...
                        children: bloc.dataAttendanceChart
                            .map((day) => buildColumnWithLabels(day as DayData))
                            .toList(),
                      ),
                    ),
                  ],
  ...
  Widget buildHeader({required AttendanceBloc bloc}) {
    return Row(
      ...
      children: [
        ...
        SizedBox(
          ...
          child: CustomDropDownButton(
            hintText: "Today",
            listData: const ["Today", "Month", "Year"],
