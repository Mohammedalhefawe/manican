...
class StatisticsWidget extends StatefulWidget {
  ...
  const StatisticsWidget(
      {super.key, required this.colors, required this.sectionsVal, required this.sectionsName});
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style:
                            TextStyle(fontSize: 4.sp, color: Colors.black,fontWeight: FontWeight.w400),
                      ),
